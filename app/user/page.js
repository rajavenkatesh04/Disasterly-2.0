...
import {
    AlertCircle, HeartHandshake, Gift, ArrowLeft, Menu, User, Home, Phone, Calendar,
    Settings, Mail, MapPin, Cake, UserCheck, Edit, Save, X, Trash2, AlertTriangle
} from 'lucide-react';
...
export default function PanelPage() {
    ...
    const getIconForSection = (section) => {
        switch (section) {
            ...
            case 'account': return <Settings className="w-5 h-5" />;
            default: return null;
        }
    };
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            await update({
                ...session,
                user: { ...session.user, name: updatedUser.name, email: updatedUser.email, image: updatedUser.image },
            });
                ...
                <div className="p-6 flex-1">
                    ...
                    <nav>
                        ...
                        <ul className="space-y-1">
                            {['account', 'emergencies', 'supports', 'donations', 'volunteering'].map(section => (
                                <li key={section}>
                                    <button
                                        onClick={() => {
                    ...
                    <div className="flex items-center">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-1">
                                {activeSection === 'account' ? 'Manage your account details' : `View your ${activeSection} history and status`}
                            </p>
                        </div>
                    </div>
